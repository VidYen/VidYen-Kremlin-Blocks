<?php
/*
 * Plugin Name: Simple Bitcoin (Altcoin) Faucets
 * Plugin URI: http://gra4.com
 * Description: Satoshi Games, Faucets, Visitor Rewarder, Referral Program, and more...
...
//		add_filter( 'after_setup_theme', 'programmatically_create_post' );
	...
	function minesweeper_shortcode_top() 
	{
		...
		$ret .= "\n<link rel='stylesheet' href='" . plugin_dir_url( __FILE__ ) . "minesweeper/csmoothness/jquery-ui-1.9.2.custom.min.css'>";
