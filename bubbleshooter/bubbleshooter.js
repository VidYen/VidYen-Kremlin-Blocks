...
// ------------------------------------------------------------------------
//console.log('bubbleshooter.js');
// The function gets called when the window is fully loaded
bubbleshooter_window_onload = function() {
//window.onload = function() {
//console.log('bubbleshooter.js onload');
    // Get the canvas and context
    var canvas = document.getElementById("bubbleshooter_viewport");
    ...
    function init() {
        // Load images
//console.log('Init');
        images = loadImages([bubbleshooter_images]);
//console.log(images);		
    ...
    function main(tframe) {
        ...
        if (!initialized) {
            ...
            var loadtext = bubbleshooter_loaded_txt + " " + loadcount + "/" + loadtotal + " images";
    ...
    function render() {
        ...
        drawCenterText(bubbleshooter_score_txt+":", scorex, scorey, 150);
        ...
        if (gamestate == gamestates.gameover) {
            ...
            context.fillStyle = "#ffffff";
            context.font = "24px Verdana";
            drawCenterText(bubbleshooter_gamover_txt, level.x, level.y + level.height / 2 + 10, level.width);
            drawCenterText(bubbleshooter_clicktostart_txt, level.x, level.y + level.height / 2 + 40, level.width);
			
			if(bubbleshooter_sent == false)
			{
				bubbleshooter_sent = true;
				sfbg_bubbleshooter_game_over(score);            
			}
        }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText(bubbleshooter_title_txt, 10, 37);
    ...
    function onMouseDown(e) {
        ...
        if (gamestate == gamestates.ready) {
            ...
            newGame();
			bubbleshooter_sent = false; //symulating
        }
