...
var Lines = (function(){
	...
	function init(){
		...
		gridElement = document.querySelector('#sfbg_ln_game .grid');
		forecastElement = document.querySelector('#sfbg_ln_game .forecast');
		scoreElement = document.querySelector('#sfbg_ln_game .score');
		recordElement = document.querySelector('.record');//TROF - not going to show
